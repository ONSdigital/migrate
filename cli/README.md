...
```
$ go get -u -d github.com/ONSdigital/migrate/cli github.com/lib/pq
$ go build -tags 'postgres' -o /usr/local/bin/migrate github.com/ONSdigital/migrate/cli
```
...
[Release Downloads](https://github.com/ONSdigital/migrate/releases)

```
$ curl -L https://github.com/ONSdigital/migrate/releases/download/$version/migrate.$platform-amd64.tar.gz | tar xvz
```
