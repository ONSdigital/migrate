...
import (
	...
	dStub "github.com/ONSdigital/migrate/database/stub"
	"github.com/ONSdigital/migrate/source"
	sStub "github.com/ONSdigital/migrate/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/ONSdigital/migrate/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/ONSdigital/migrate/source/stub"`
